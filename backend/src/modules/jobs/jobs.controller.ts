...
export class JobsController {
  ...
  @UseGuards(TenantGuard, RolesGuard)
  @Roles('owner')
  createOfficeStaff(@Body() body: CreateOfficeStaffDto, @Req() req: UserRequest) {
    return this.jobsService.createOfficeStaff(body, req.context);
  }
  ...
  transitionOfficeJob(
    ...
    return this.jobsService.updateStatus(
      id,
      {
        ...
        installedBrandId: body.installedBrandId,
        installationCharge: body.installationCharge,
