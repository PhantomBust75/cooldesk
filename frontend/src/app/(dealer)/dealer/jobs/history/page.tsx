  ...
  return (
    <div style={{ padding: "28px 32px" }}>
      <div style={{ marginBottom: "20px" }}>
        <h1 style={{ fontSize: "24px", fontWeight: 600, color: "#0A0A0A", margin: 0 }}>Job History</h1>
      ...
      <div style={{ backgroundColor: "#fff", border: "1px solid #E5E5E5", borderRadius: "12px", overflow: "hidden" }}>
        ...
        <div
          style={{
            display: "grid",
            gridTemplateColumns: "120px 1fr 110px 150px 130px",
            padding: "12px 20px",
        ...
        >
          {["JOB ID", "CUSTOMER", "TYPE", "DATE", "STATUS"].map((h) => (
            <span key={h} style={{ fontSize: "11px", fontWeight: 500, color: "#737373", textTransform: "uppercase", letterSpacing: "0.05em" }}>
              {h}
            </span>
          ))}
        </div>
          ...
          history.map((job, i) => {
            ...
            return (
              ...
              >
                ...
                <span>
                  <span style={{ fontSize: "12px", fontWeight: 500, color: status.color, backgroundColor: status.bg, borderRadius: "6px", padding: "3px 8px" }}>
                    {status.label}
                  </span>
                </span>
              </div>
