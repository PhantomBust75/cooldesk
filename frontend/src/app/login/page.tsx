...
export default function LoginPage() {
  ...
  const isRedirecting = useMemo(() => isReady && isAuthenticated, [isReady, isAuthenticated]);
          ...
          <form onSubmit={onSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px" }} suppressHydrationWarning>
            <div>
              ...
              <input
                ...
                onBlur={(event) => (event.currentTarget.style.borderColor = "#E5E5E5")}
            ...
            {errorMessage ? (
              <div style={{ padding: "9px 12px", backgroundColor: "#FEE2E2", borderRadius: "8px", fontSize: "13px", color: "#991B1B", display: "flex", gap: "6px", alignItems: "center" }}>
            ...
            <button
              ...
              style={{ width: "100%", padding: "10px", borderRadius: "8px", border: "none", backgroundColor: isSubmitting ? "#A3A3A3" : "#0A0A0A", color: "#fff", fontSize: "13px", fontWeight: 500, cursor: isSubmitting ? "not-allowed" : "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "7px", marginTop: "4px" }}
            >
              <Lock size={14} strokeWidth={1.5} />
